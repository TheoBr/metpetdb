...
public class ImageOnGridDTO extends MObjectDTO {
	...
	private transient Set<MineralAnalysisDTO> mineralAnalyses;
	...
	public void delete() {
		...
		while (itr.hasNext()) {
			((MineralAnalysisDTO) itr.next()).setImage(null);
		}
	}
	...
	public void addMineralAnalysis(final MineralAnalysisDTO ma) {
		if (mineralAnalyses == null)
			mineralAnalyses = new HashSet<MineralAnalysisDTO>();
	...
	public void resizeImage(int width, int height, boolean resize) {
		...
		final Iterator<MineralAnalysisDTO> itr = this.getMineralAnalyses().iterator();
		while (itr.hasNext()) {
	...
	public boolean equals(final Object o) {
		return o instanceof ImageOnGridDTO && grid == ((ImageOnGridDTO) o).getGrid()
