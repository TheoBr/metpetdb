...
public class SampleDAOImpl extends JdbcTemplate {
	...
	public EarthChemSample getEarthChemSample(String sampleNumber) {
		return this.query(earthChemSampleQuery, new Object[] { sampleNumber },
				new EarthChemSampleMapper());
	}
