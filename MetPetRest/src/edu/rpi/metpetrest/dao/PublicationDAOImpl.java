...
public class PublicationDAOImpl extends JdbcTemplate {
	...
	private static final String publicationQuery = "select title, first_author, second_authors, journal_name, full_text as abstract, reference_number, reference_id, journal_name_2, doi, publication_year from georeference;";
