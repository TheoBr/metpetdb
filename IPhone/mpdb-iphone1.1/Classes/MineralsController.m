...
-(void)backToCriteria
{
	...
	for(p=0; p<[[currentSearchData minerals] count]; p++)
	{
		if([[[currentSearchData minerals] objectAtIndex:p] isEqualToString:mineralName])
		{
	...
	{
		[[currentSearchData minerals] addObject:mineralName];
	}		
