...
public class SearchReferenceAttribute extends SearchGenericAttribute {
	...
	public SearchReferenceAttribute(final ObjectConstraint sc) {
		super(sc);
		sta = new MultipleSuggestTextAttribute(sc){
			...
			public void onChange(final Widget sender){
				SearchReferenceAttribute.this.getSearchInterface().createCritera();
			}
	...
	public SearchReferenceAttribute(final StringConstraint sc) {
		super(sc);
	}
