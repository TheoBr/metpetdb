...
class PrefixTree extends AbstractCollection<String> {
  ...
  private static class PrefixTreeIterator implements Iterator<String> {
    ...
    private native void addTree(PrefixTree tree, String prefix) /*-{
      var suffixes = [];
      for (suffix in tree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::suffixes) {
        suffixes.push(suffix);
      }

      var frame = {
        suffixNames: suffixes,
        subtrees: tree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::subtrees,
        prefix: prefix,
        index: 0
      };

      var stack = this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree$PrefixTreeIterator::stack;
      stack.push(frame);
    }-*/;
    ...
    private native void init() /*-{
      this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree$PrefixTreeIterator::stack = [];
    }-*/;
    ...
    private native String nextImpl(boolean peek) /*-{
      var stack = this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree$PrefixTreeIterator::stack;
      var safe = @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::safe(Ljava/lang/String;)
      var unsafe = @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::unsafe(Ljava/lang/String;)
        ...
        if (frame.index < frame.suffixNames.length) {
          ...
          if (frame.index < frame.suffixNames.length) {
            ...
            for (key in frame.subtrees) {
              ...
              this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree$PrefixTreeIterator::addTree(Ledu/rpi/metpetdb/client/ui/widgets/PrefixTree;Ljava/lang/String;)(subtree, target);
            }
          }
  ...
  public native boolean add(String s) /*-{
    var suffixes =
        this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::suffixes;
    var subtrees =
        this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::subtrees;
    var prefixLength =
        this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::prefixLength;
    ...
    if (s.length <= prefixLength) {
      var safeKey = @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::safe(Ljava/lang/String;)(s);
      if (suffixes.hasOwnProperty(safeKey)) {
        return false;
      } else {
        // Each tree keeps a count of how large it and its children are.
        this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::size++;
    ...
    // Add the string to the appropriate PrefixTree.
      ...
      var prefix = @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::safe(Ljava/lang/String;)(s.slice(0, prefixLength));
      var theTree;

      if (subtrees.hasOwnProperty(prefix)) {
        theTree = subtrees[prefix];
      } else {
        theTree = @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::createPrefixTree(I)(prefixLength << 1);
        subtrees[prefix] = theTree;
      }

      var slice = s.slice(prefixLength);
      if (theTree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::add(Ljava/lang/String;)(slice)) {
  ...
  public native void clear() /*-{
    this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::size = 0;
    this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::subtrees = {};
    this.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::suffixes = {};
  }-*/;
  ...
  protected native void suggestImpl(String search, String prefix,
    ...
    if (search.length > prefix.length + prefixLength) {
      var key = @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::safe(Ljava/lang/String;)(search.slice(prefix.length, prefix.length + prefixLength));

      // Just pick the correct subtree, if it exists, and call suggestImpl.
      if (subtrees.hasOwnProperty(key)) {
        var subtree = subtrees[key];
        var target = prefix + @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::unsafe(Ljava/lang/String;)(key);
        subtree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::suggestImpl(Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;I)(search, target, output, limit);
      }
    ...
    // The answer can only exist in this tree's suffixes or subtree keys.
     ...
     for (suffix in suffixes) {
       var target = prefix + @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::unsafe(Ljava/lang/String;)(suffix);
     ...
     for (var key in subtrees) {
       ...
       if (target.indexOf(search) == 0) {
         ...
         if ((subtree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::size <= limit - output.@java.util.Collection::size()()) ||
             (subtree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::size == 1)) {
           subtree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::dump(Ljava/util/Collection;Ljava/lang/String;)(output, target);

         // Otherwise, include as many answers as we can by truncating the suffix
         } else {

           // Always fully-specify suffixes.
           for (var suffix in subtree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::suffixes) {
             output.@java.util.Collection::add(Ljava/lang/Object;)(target + @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::unsafe(Ljava/lang/String;)(suffix));
           }

           // Give the keys of the subtree.
           for (var subkey in subtree.@edu.rpi.metpetdb.client.ui.widgets.PrefixTree::subtrees) {
             output.@java.util.Collection::add(Ljava/lang/Object;)(target + @edu.rpi.metpetdb.client.ui.widgets.PrefixTree::unsafe(Ljava/lang/String;)(subkey) + "...");
           }
         }
       }
     }
