 ...
 * </p>
 */
public class MTabPanel extends Composite implements TabListener,
	 ...
	 */
	private static class UnmodifiableTabBar extends MTabBar {
	...
	private final String STYLENAME_DEFAULT = "tabPanel";
	...
	public MTabPanel() {
		...
		deck.setStyleName(STYLENAME_DEFAULT + "Bottom");
	}
