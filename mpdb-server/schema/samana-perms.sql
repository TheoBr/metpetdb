...
grant all on admin_user_seq to metpetdb_dev; 
grant all on chemical_analysis_elements_seq to metpetdb_dev; 
grant all on chemical_analysis_oxides_seq to metpetdb_dev; 
grant all on element_seq to metpetdb_dev; 
grant all on grid_seq to metpetdb_dev; 
grant all on image_comment_seq to metpetdb_dev; 
grant all on image_format_seq to metpetdb_dev; 
grant all on image_on_grid_seq to metpetdb_dev; 
grant all on image_seq to metpetdb_dev; 
grant all on image_type_seq to metpetdb_dev; 
grant all on metamorphic_grade_seq to metpetdb_dev; 
grant all on mineral_seq to metpetdb_dev; 
grant all on mineral_types_seq to metpetdb_dev; 
grant all on oxide_seq to metpetdb_dev; 
grant all on project_seq to metpetdb_dev; 
grant all on mineral_seq to metpetdb_dev; 
grant all on reference_seq to metpetdb_dev; 
grant all on region_seq to metpetdb_dev; 
grant all on rock_type_seq to metpetdb_dev; 
grant all on sample_comments_seq to metpetdb_dev; 
grant all on sample_seq to metpetdb_dev; 
grant all on subsample_seq to metpetdb_dev; 
grant all on upload_files_seq to metpetdb_dev; 
grant all on user_seq to metpetdb_dev; 
