CREATE TABLE mineral_analyses
(
   mineral_analysis_id INT8 NOT NULL,
   ...
   CONSTRAINT mineral_analyses_fk_user FOREIGN KEY (user_id)
     REFERENCES users (user_id),
   CONSTRAINT mineral_analyses_fk_reference FOREIGN KEY (reference_id)
      REFERENCES reference (reference_id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
   CONSTRAINT mineral_analyses_fk_images FOREIGN KEY (image_id)
      REFERENCES images(image_id) ON DELETE SET NULL,
   CONSTRAINT mineral_analyses_fk_mineral FOREIGN KEY (mineral_id)
...
CREATE TABLE mineral_analysis_elements
(
    mineral_analysis_id INT8 NOT NULL,
    element_id INT2 NOT NULL,
    ...
    CONSTRAINT analysis_elements_sk PRIMARY KEY (mineral_analysis_id, element_id),
    CONSTRAINT analysis_elements_fk_mineral_analyses FOREIGN KEY (mineral_analysis_id) REFERENCES mineral_analyses(mineral_analysis_id),
...
CREATE TABLE mineral_analysis_oxides
(
    mineral_analysis_id INT8 NOT NULL,
    oxide_id INT2 NOT NULL,
    amount     FLOAT4 NOT NULL,
    precision  FLOAT4,
    precision_type  VARCHAR(3),
    CONSTRAINT analysis_oxides_sk PRIMARY KEY (mineral_analysis_id, oxide_id),
    CONSTRAINT analysis_oxides_fk_mineral_analyses FOREIGN KEY (mineral_analysis_id) REFERENCES mineral_analyses(mineral_analysis_id),
