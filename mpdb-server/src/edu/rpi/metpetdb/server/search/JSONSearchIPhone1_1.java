...
public class JSONSearchIPhone1_1 extends HttpServlet{
	...
	protected void doGet(final HttpServletRequest request,
		...
		try{
			...
			if (request.getParameter(NORTH_PARAMETER) != null && request.getParameter(SOUTH_PARAMETER) != null && request.getParameter(WEST_PARAMETER)!= null && request.getParameter(EAST_PARAMETER) != null) {
				...
				{
					outputSearchJSON(search(north,south, east, west, session, publicPrivate, owners, rockTypes, metamorphicGrades, minerals, region, username, p, request.getParameter("currentLatitude"), request.getParameter("currentLongitude")),response);
				}
			} 
			...
			//String region = new String();
				...
				{
					outputSearchJSON(search(session, publicPrivate, owners, rockTypes, metamorphicGrades, minerals, region, username, p, response, request.getParameter("currentLatitude"), request.getParameter("currentLongitude")), response);
				}
			}
